...
<asp:Content ID="Content2" ContentPlaceHolderID="titulo" runat="server">
    <asp:Image ImageUrl="~/images/stadium.png" runat="server" Width="25" Height="25"/>
    Registro de Partidos y Resultados
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="contenido" runat="server">
    <asp:DetailsView ID="DVPartidos" runat="server" AutoGenerateRows="False" DataKeyNames="idPartido" DataSourceID="DSPartido" DefaultMode="Insert" Height="50px" Width="98%" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" Font-Names="Segoe UI" GridLines="None">
